...
function cpt_carousel_enqueue_scripts() {
    ...
    wp_enqueue_style( 'cpt-carousel-style', plugins_url( '/css/carousel-style.css', __FILE__ ), array(), "1.0.3" );

    // Swiper JS
    wp_enqueue_script( 'swiper-js', 'https://unpkg.com/swiper/swiper-bundle.min.js', array(), null, true );

    // Custom JS for the carousel
    wp_enqueue_script( 'cpt-carousel-script', plugins_url( '/js/carousel-script.js', __FILE__ ), array( 'swiper-js' ), "1.0.3", true );
}
...
function cpt_carousel_shortcode() {
    ...
    if ( $query->have_posts() ) {
        ...
        <div class="carousel-description">
            <?php while ( $query->have_posts() ) : $query->the_post(); ?>
                <div class="swiper-content" data-id="<?php echo get_the_ID() ?>" style="display:none;">
